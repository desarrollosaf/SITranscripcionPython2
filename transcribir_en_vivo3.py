        ...
        try:
            ...
            if r["fuerte"] and r["similitud"] >= exigencia \
                ...
                aviso = (f"\n[voz] {hms(tramo['ini'])}–{hms(tramo['fin'])}: "
                         ...
                         f"{r['similitud']:.2f}, margen {r['margen']:.2f}); "
                         f"marcado como "
                ...
                if r["margen"] < MARGEN_MIN_VOZ:
                    razones.append(
                        f"margen de solo {r['margen']:.2f} sobre el "
                        f"segundo candidato (mínimo {MARGEN_MIN_VOZ:.2f}: "
                        "hay otra voz de perfil muy parecido)")
